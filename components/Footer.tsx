...
const Footer = () => (
    <footer className="bg-dark-blue w-screen flex flex-col justify-between text-white bottom-0 p-2 xl:text-xl text-lg mt-12 z-40 relative">
        <Row className='lg:justify-between my-0'>
            ...
            <div className="text-center lg:text-right md:mx-12 lg:mx-0 lg:mr-12 flex flex-col justify-between mt-5 md:mb-2 lg:my-0 lg:mt-10">
